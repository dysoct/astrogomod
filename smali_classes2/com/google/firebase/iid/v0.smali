...
.method public static a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-static {p0, v0, p2}, Lcom/google/firebase/iid/v0;->l(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method private b(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/iid/v0;->g(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_2
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/firebase/iid/v0;->f(Landroid/content/Context;)Z
    ...
    .line 6
    invoke-static {p1, p2}, Lcom/google/firebase/iid/y0;->h(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public static declared-synchronized c()Lcom/google/firebase/iid/v0;
    .locals 2
    .annotation build Lcom/google/android/gms/common/annotation/a;
    .end annotation
...
.method private declared-synchronized g(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    .locals 4
    .annotation build Landroidx/annotation/i0;
    .end annotation
...
.method public static h(Lcom/google/firebase/iid/v0;)V
    .locals 0
...
.method public static j(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 1
    invoke-static {p0, v0, p1}, Lcom/google/firebase/iid/v0;->l(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method private static l(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
    .locals 2
...
.method public i(Landroid/content/Context;Landroid/content/Intent;)I
    .locals 2
    .annotation build Landroidx/annotation/e0;
    .end annotation
