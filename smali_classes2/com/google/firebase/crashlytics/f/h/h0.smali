...
.method static synthetic f(Lcom/google/firebase/crashlytics/f/h/h0;Ld/e/b/d/p/m;)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/f/h/h0;->l(Ld/e/b/d/p/m;)Z
...
.method public static g(Landroid/content/Context;Lcom/google/firebase/crashlytics/f/h/y;Lcom/google/firebase/crashlytics/f/m/h;Lcom/google/firebase/crashlytics/f/h/b;Lcom/google/firebase/crashlytics/f/i/b;Lcom/google/firebase/crashlytics/f/h/j0;Lcom/google/firebase/crashlytics/f/r/d;Lcom/google/firebase/crashlytics/f/q/e;)Lcom/google/firebase/crashlytics/f/h/h0;
    ...
    invoke-interface {p2}, Lcom/google/firebase/crashlytics/f/m/h;->a()Ljava/lang/String;
...
.method private static j(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Lcom/google/firebase/crashlytics/f/j/v$c$a;->b(Ljava/lang/String;)Lcom/google/firebase/crashlytics/f/j/v$c$a;
    ...
    invoke-virtual {v2, v1}, Lcom/google/firebase/crashlytics/f/j/v$c$a;->c(Ljava/lang/String;)Lcom/google/firebase/crashlytics/f/j/v$c$a;
...
.method static synthetic k(Lcom/google/firebase/crashlytics/f/j/v$c;Lcom/google/firebase/crashlytics/f/j/v$c;)I
    .locals 0

    .line 1
    invoke-virtual {p0}, Lcom/google/firebase/crashlytics/f/j/v$c;->b()Ljava/lang/String;
...
.method private l(Ld/e/b/d/p/m;)Z
    .locals 3
    ...
    .line 4
    invoke-virtual {p1}, Lcom/google/firebase/crashlytics/f/h/q;->c()Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lcom/google/firebase/crashlytics/f/m/g;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/crashlytics/f/b;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private m(Ljava/lang/Throwable;Ljava/lang/Thread;Ljava/lang/String;JZ)V
    ...
    .line 5
    invoke-virtual/range {v3 .. v11}, Lcom/google/firebase/crashlytics/f/h/p;->b(Ljava/lang/Throwable;Ljava/lang/Thread;Ljava/lang/String;JIIZ)Lcom/google/firebase/crashlytics/f/j/v$e$d;

    move-result-object v3

    .line 6
    invoke-virtual {v3}, Lcom/google/firebase/crashlytics/f/j/v$e$d;->g()Lcom/google/firebase/crashlytics/f/j/v$e$d$b;
    ...
    invoke-virtual {v5}, Lcom/google/firebase/crashlytics/f/i/b;->d()Ljava/lang/String;
    ...
    invoke-virtual {v6, v5}, Lcom/google/firebase/crashlytics/f/j/v$e$d$d$a;->b(Ljava/lang/String;)Lcom/google/firebase/crashlytics/f/j/v$e$d$d$a;
    ...
    .line 9
    invoke-virtual {v4, v5}, Lcom/google/firebase/crashlytics/f/j/v$e$d$b;->d(Lcom/google/firebase/crashlytics/f/j/v$e$d$d;)Lcom/google/firebase/crashlytics/f/j/v$e$d$b;
    ...
    invoke-static {v5}, Lcom/google/firebase/crashlytics/f/h/h0;->j(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 14
    invoke-virtual {v3}, Lcom/google/firebase/crashlytics/f/j/v$e$d;->b()Lcom/google/firebase/crashlytics/f/j/v$e$d$a;

    move-result-object v3

    .line 15
    invoke-virtual {v3}, Lcom/google/firebase/crashlytics/f/j/v$e$d$a;->f()Lcom/google/firebase/crashlytics/f/j/v$e$d$a$a;

    move-result-object v3

    .line 16
    invoke-static {v5}, Lcom/google/firebase/crashlytics/f/j/w;->c(Ljava/util/List;)Lcom/google/firebase/crashlytics/f/j/w;

    move-result-object v5

    invoke-virtual {v3, v5}, Lcom/google/firebase/crashlytics/f/j/v$e$d$a$a;->c(Lcom/google/firebase/crashlytics/f/j/w;)Lcom/google/firebase/crashlytics/f/j/v$e$d$a$a;
    ...
    .line 18
    invoke-virtual {v4, v3}, Lcom/google/firebase/crashlytics/f/j/v$e$d$b;->b(Lcom/google/firebase/crashlytics/f/j/v$e$d$a;)Lcom/google/firebase/crashlytics/f/j/v$e$d$b;
    ...
    invoke-virtual {v3, v4, v1, v2}, Lcom/google/firebase/crashlytics/f/m/g;->B(Lcom/google/firebase/crashlytics/f/j/v$e$d;Ljava/lang/String;Z)V
...
.method public c(Ljava/lang/String;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/google/firebase/crashlytics/f/h/p;->d(Ljava/lang/String;J)Lcom/google/firebase/crashlytics/f/j/v;
    ...
    invoke-virtual {p2, p1}, Lcom/google/firebase/crashlytics/f/m/g;->C(Lcom/google/firebase/crashlytics/f/j/v;)V
...
.method public d(JLjava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/google/firebase/crashlytics/f/i/b;->i(JLjava/lang/String;)V
...
.method public h(Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 3
    invoke-interface {v1}, Lcom/google/firebase/crashlytics/f/h/c0;->b()Lcom/google/firebase/crashlytics/f/j/v$d$b;
    ...
    invoke-virtual {v1, v0}, Lcom/google/firebase/crashlytics/f/j/v$d$a;->b(Lcom/google/firebase/crashlytics/f/j/w;)Lcom/google/firebase/crashlytics/f/j/v$d$a;
    ...
    .line 7
    invoke-virtual {p2, p1, v0}, Lcom/google/firebase/crashlytics/f/m/g;->j(Ljava/lang/String;Lcom/google/firebase/crashlytics/f/j/v$d;)V
...
.method public i(J)V
    ...
    invoke-virtual {v0, v1, p1, p2}, Lcom/google/firebase/crashlytics/f/m/g;->i(Ljava/lang/String;J)V
...
.method public n(Ljava/lang/Throwable;Ljava/lang/Thread;J)V
    ...
    .line 1
    invoke-direct/range {v0 .. v6}, Lcom/google/firebase/crashlytics/f/h/h0;->m(Ljava/lang/Throwable;Ljava/lang/Thread;Ljava/lang/String;JZ)V
...
.method public p()V
    ...
    invoke-virtual {v2, v1, v0}, Lcom/google/firebase/crashlytics/f/m/g;->D(Ljava/lang/String;Ljava/lang/String;)V
...
.method public q()V
    ...
    invoke-virtual {v0}, Lcom/google/firebase/crashlytics/f/m/g;->g()V

    return-void
.end method

.method r(Ljava/util/concurrent/Executor;Lcom/google/firebase/crashlytics/f/h/u;)Ld/e/b/d/p/m;
    .locals 5
    ...
    invoke-virtual {p1}, Lcom/google/firebase/crashlytics/f/m/g;->g()V
    ...
    .line 6
    invoke-virtual {v0}, Lcom/google/firebase/crashlytics/f/m/g;->x()Ljava/util/List;
    ...
    .line 9
    invoke-virtual {v2}, Lcom/google/firebase/crashlytics/f/h/q;->b()Lcom/google/firebase/crashlytics/f/j/v;

    move-result-object v3

    invoke-virtual {v3}, Lcom/google/firebase/crashlytics/f/j/v;->k()Lcom/google/firebase/crashlytics/f/j/v$f;
    ...
    invoke-virtual {v2}, Lcom/google/firebase/crashlytics/f/h/q;->c()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/google/firebase/crashlytics/f/m/g;->h(Ljava/lang/String;)V
    ...
    .line 14
    invoke-virtual {v3, v2}, Lcom/google/firebase/crashlytics/f/p/c;->e(Lcom/google/firebase/crashlytics/f/h/q;)Ld/e/b/d/p/m;

    move-result-object v2

    invoke-static {p0}, Lcom/google/firebase/crashlytics/f/h/f0;->b(Lcom/google/firebase/crashlytics/f/h/h0;)Ld/e/b/d/p/c;

    move-result-object v3

    .line 15
    invoke-virtual {v2, p1, v3}, Ld/e/b/d/p/m;->n(Ljava/util/concurrent/Executor;Ld/e/b/d/p/c;)Ld/e/b/d/p/m;
    ...
    .line 17
    :cond_2
    invoke-static {v1}, Ld/e/b/d/p/p;->h(Ljava/util/Collection;)Ld/e/b/d/p/m;
