...
.field protected static final skipBufferReference:Ljava/util/concurrent/atomic/AtomicReference;
...
# instance fields
.field protected final allowCrossProtocolRedirects:Z
...
.field protected final connectTimeoutMillis:I
...
.field protected final readTimeoutMillis:I
...
.method protected static getContentLength(Ljava/net/HttpURLConnection;)J
    .locals 10
...
.method protected static handleRedirect(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    .locals 2
...
.method protected static maybeTerminateInputStream(Ljava/net/HttpURLConnection;J)V
    .locals 2
...
.method protected makeConnection(Lcom/google/android/exoplayer2/upstream/DataSpec;)Ljava/net/HttpURLConnection;
    .locals 23
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 9
    invoke-virtual/range {v0 .. v10}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->makeConnection(Ljava/net/URL;I[BJJZZZ)Ljava/net/HttpURLConnection;
    ...
    .line 10
    invoke-virtual/range {v4 .. v14}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->makeConnection(Ljava/net/URL;I[BJJZZZ)Ljava/net/HttpURLConnection;
...
.method protected makeConnection(Ljava/net/URL;I[BJJZZZ)Ljava/net/HttpURLConnection;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public open(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    .line 4
    iput-wide v3, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->contentLength:J
    ...
    .line 6
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->makeConnection(Lcom/google/android/exoplayer2/upstream/DataSpec;)Ljava/net/HttpURLConnection;

    move-result-object v6

    iput-object v6, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->connection:Ljava/net/HttpURLConnection;
    :try_end_0
    ...
    iput v6, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->responseCode:I
    ...
    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->contentLength:J
    ...
    .line 19
    :cond_4
    iget-wide v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->contentLength:J
    ...
    invoke-direct {v1, v0, p1, v5}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/DataSpec;I)V
    ...
    invoke-direct {v2, v0, v1, p1, v5}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/lang/String;Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/DataSpec;I)V
...
.method public read([BII)I
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->readInternal([BII)I
