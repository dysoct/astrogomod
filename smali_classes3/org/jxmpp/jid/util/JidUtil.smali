...
.method public static validateEntityBareJid(Ljava/lang/CharSequence;)Lorg/jxmpp/jid/EntityBareJid;
    ...
    const-string p0, "\' has empty domainpart"
    ...
    const-string p0, "\' has empty localpart"
    ...
    const-string p0, "\' contains multiple \'@\' characters"
    ...
    const-string p0, "\' does not contain a \'@\' character"
...
.method public static validateTypicalEntityBareJid(Ljava/lang/CharSequence;)Lorg/jxmpp/jid/EntityBareJid;
    ...
    .line 3
    :cond_0
    new-instance p0, Lorg/jxmpp/jid/util/JidUtil$NotAEntityBareJidStringException;

    const-string v0, "Domainpart does not include a dot (\'.\') character"

    invoke-direct {p0, v0}, Lorg/jxmpp/jid/util/JidUtil$NotAEntityBareJidStringException;-><init>(Ljava/lang/String;)V
