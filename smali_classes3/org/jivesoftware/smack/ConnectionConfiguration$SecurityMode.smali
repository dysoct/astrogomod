...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;

    const-string v3, "ifpossible"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;->ifpossible:Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;

    .line 3
    new-instance v3, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;

    const-string v5, "disabled"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;->disabled:Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;

    const/4 v5, 0x3

    new-array v5, v5, [Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;
    ...
    .line 4
    sput-object v5, Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;->$VALUES:[Lorg/jivesoftware/smack/ConnectionConfiguration$SecurityMode;
