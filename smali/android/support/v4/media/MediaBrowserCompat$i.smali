...
.method private r(Landroid/os/Messenger;Ljava/lang/String;)Z
    .locals 2
...
.method public g(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$c;)V
    .locals 3
    ...
    invoke-virtual {v1, p1, p2, v0, v2}, Landroid/support/v4/media/MediaBrowserCompat$l;->h(Ljava/lang/String;Landroid/os/Bundle;Lb/a/b/a/b;Landroid/os/Messenger;)V
    :try_end_0
...
.method public h(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroid/support/v4/media/MediaBrowserCompat$i;->r(Landroid/os/Messenger;Ljava/lang/String;)Z
...
.method public j(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, p2}, Lc/f/i;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public k(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$d;)V
    ...
    invoke-virtual {v2, p1, v0, v3}, Landroid/support/v4/media/MediaBrowserCompat$l;->d(Ljava/lang/String;Lb/a/b/a/b;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public n(Landroid/os/Messenger;)V
    .locals 2
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat$i;->f(I)Ljava/lang/String;
...
.method public p(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$k;)V
    .locals 3
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    ...
    invoke-virtual {v1, p1, p2, v0, v2}, Landroid/support/v4/media/MediaBrowserCompat$l;->g(Ljava/lang/String;Landroid/os/Bundle;Lb/a/b/a/b;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 7
    invoke-static {p3}, Landroid/support/v4/media/MediaBrowserCompat$i;->f(I)Ljava/lang/String;
