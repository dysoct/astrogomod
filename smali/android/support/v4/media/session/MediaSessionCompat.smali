...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$e;)V
    ...
    .line 32
    invoke-interface {p2}, Landroid/support/v4/media/session/MediaSessionCompat$e;->q()Ljava/lang/Object;

    move-result-object p2

    invoke-static {p2}, Landroid/support/v4/media/session/f;->d(Ljava/lang/Object;)Z
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    .line 7
    invoke-static {p1}, Landroidx/media/r/a;->c(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    .line 15
    invoke-interface {p3, p4}, Landroid/support/v4/media/session/MediaSessionCompat$e;->i(Landroid/app/PendingIntent;)V
...
.method static j(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 14
...
.method public A(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->g(Ljava/lang/CharSequence;)V
...
.method public B(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->j(I)V
...
.method public C(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->setRepeatMode(I)V
...
.method public D(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->d(Landroid/app/PendingIntent;)V
...
.method public E(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->F1(I)V
...
.method public d()Ljava/lang/String;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$e;->c()Ljava/lang/String;
...
.method public final f()Landroidx/media/j$b;
    .locals 1
...
.method public g()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$e;->q()Ljava/lang/Object;
...
.method public h()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$e;->m()Ljava/lang/Object;
...
.method public o(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->n(Z)V
...
.method public q(Landroid/support/v4/media/session/MediaSessionCompat$d;Landroid/os/Handler;)V
    ...
    invoke-interface {p1, p2, p2}, Landroid/support/v4/media/session/MediaSessionCompat$e;->e(Landroid/support/v4/media/session/MediaSessionCompat$d;Landroid/os/Handler;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$e;->e(Landroid/support/v4/media/session/MediaSessionCompat$d;Landroid/os/Handler;)V
...
.method public r(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->l1(Z)V
...
.method public u(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->i(Landroid/app/PendingIntent;)V
...
.method public v(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->h(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public w(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->p(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public x(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->f(I)V

    return-void
.end method

.method public y(Landroidx/media/o;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->r(Landroidx/media/o;)V
...
.method public z(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$e;->l(Ljava/util/List;)V
