...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/l0;->a:Lc/f/i;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/l0;->b:Lc/f/f;

    return-void
.end method

.method private l(Landroidx/recyclerview/widget/RecyclerView$g0;I)Landroidx/recyclerview/widget/RecyclerView$m$d;
    .locals 4

    .line 1
    iget-object v0, p0, Landroidx/recyclerview/widget/l0;->a:Lc/f/i;
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Landroidx/recyclerview/widget/l0;->a:Lc/f/i;

    invoke-virtual {v1, p1}, Lc/f/i;->o(I)Ljava/lang/Object;
...
# virtual methods
.method a(Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$m$d;)V
    .locals 2
...
.method b(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    .locals 2
...
.method c(JLandroidx/recyclerview/widget/RecyclerView$g0;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/recyclerview/widget/l0;->b:Lc/f/f;

    invoke-virtual {v0, p1, p2, p3}, Lc/f/f;->t(JLjava/lang/Object;)V

    return-void
.end method

.method d(Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$m$d;)V
    .locals 2
...
.method e(Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$m$d;)V
    .locals 2
...
.method f()V
    ...
    invoke-virtual {v0}, Lc/f/f;->c()V

    return-void
.end method

.method g(J)Landroidx/recyclerview/widget/RecyclerView$g0;
    .locals 1
...
.method h(Landroidx/recyclerview/widget/RecyclerView$g0;)Z
    .locals 1
...
.method i(Landroidx/recyclerview/widget/RecyclerView$g0;)Z
    .locals 1
...
.method m(Landroidx/recyclerview/widget/RecyclerView$g0;)Landroidx/recyclerview/widget/RecyclerView$m$d;
    .locals 1
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/l0;->l(Landroidx/recyclerview/widget/RecyclerView$g0;I)Landroidx/recyclerview/widget/RecyclerView$m$d;
...
.method n(Landroidx/recyclerview/widget/RecyclerView$g0;)Landroidx/recyclerview/widget/RecyclerView$m$d;
    .locals 1
    .annotation build Landroidx/annotation/i0;
    .end annotation
...
.method o(Landroidx/recyclerview/widget/l0$b;)V
    ...
    invoke-virtual {v1, v0}, Lc/f/i;->k(I)Ljava/lang/Object;
    ...
    .line 3
    iget-object v2, p0, Landroidx/recyclerview/widget/l0;->a:Lc/f/i;

    invoke-virtual {v2, v0}, Lc/f/i;->m(I)Ljava/lang/Object;
    ...
    .line 5
    invoke-interface {p1, v1}, Landroidx/recyclerview/widget/l0$b;->a(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroidx/recyclerview/widget/l0$b;->b(Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$m$d;Landroidx/recyclerview/widget/RecyclerView$m$d;)V
...
.method p(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    .locals 1
...
.method q(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    .locals 2

    .line 1
    iget-object v0, p0, Landroidx/recyclerview/widget/l0;->b:Lc/f/f;

    invoke-virtual {v0}, Lc/f/f;->C()I
    ...
    .line 2
    iget-object v1, p0, Landroidx/recyclerview/widget/l0;->b:Lc/f/f;

    invoke-virtual {v1, v0}, Lc/f/f;->D(I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lc/f/f;->y(I)V
