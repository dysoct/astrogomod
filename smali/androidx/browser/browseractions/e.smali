...
.field private static y:Landroidx/browser/browseractions/e$a;
...
.method public static d(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 2
    invoke-static {p0, p1, v0}, Landroidx/browser/browseractions/e;->e(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V

    return-void
.end method

.method static e(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    .locals 4
    ...
    :cond_4
    :goto_2
    invoke-static {p0, p1}, Landroidx/browser/browseractions/e;->h(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public static f(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Landroidx/browser/browseractions/e;->d(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private static h(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 4
    invoke-static {p1}, Landroidx/browser/browseractions/e;->j(Ljava/util/ArrayList;)Ljava/util/List;
    ...
    .line 5
    :goto_0
    invoke-static {p0, v0, v1, p1}, Landroidx/browser/browseractions/e;->i(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V

    return-void
.end method

.method private static i(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p2, p0, p1, p3}, Landroidx/browser/browseractions/d;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V

    .line 2
    invoke-virtual {p2}, Landroidx/browser/browseractions/d;->a()V

    .line 3
    sget-object p0, Landroidx/browser/browseractions/e;->y:Landroidx/browser/browseractions/e$a;
...
.method public static j(Ljava/util/ArrayList;)Ljava/util/List;
    ...
    invoke-direct {v5, v3, v4, v2}, Landroidx/browser/browseractions/a;-><init>(Ljava/lang/String;Landroid/app/PendingIntent;I)V
...
.method static k(Landroidx/browser/browseractions/e$a;)V
    .locals 0
    .annotation build Landroidx/annotation/p0;
        value = {
            .enum Landroidx/annotation/p0$a;->B:Landroidx/annotation/p0$a;
    ...
    .line 1
    sput-object p0, Landroidx/browser/browseractions/e;->y:Landroidx/browser/browseractions/e$a;
