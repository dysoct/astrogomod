...
.field private static final e:Ljava/lang/String; = "AppCompatViewInflater"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/AppCompatViewInflater;->f:Ljava/util/Map;
...
.method private r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/app/AppCompatViewInflater;->f:Ljava/util/Map;
...
.method private static t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 6
    instance-of p1, p0, Lc/a/f/d;

    if-eqz p1, :cond_2

    move-object p1, p0

    check-cast p1, Lc/a/f/d;

    .line 7
    invoke-virtual {p1}, Lc/a/f/d;->c()I
    ...
    .line 8
    :cond_2
    new-instance p1, Lc/a/f/d;

    invoke-direct {p1, p0, p2}, Lc/a/f/d;-><init>(Landroid/content/Context;I)V
...
.method protected d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/h;
    .locals 1
    .annotation build Landroidx/annotation/h0;
    .end annotation
...
.method protected e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
    .locals 1
    .annotation build Landroidx/annotation/h0;
    .end annotation
...
.method protected g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    .locals 1
    .annotation build Landroidx/annotation/h0;
    .end annotation
...
.method final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 6
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    .line 10
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/h;
    ...
    .line 12
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/e;
    ...
    .line 14
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    .line 16
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/c0;
    ...
    .line 18
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/t;
    ...
    .line 20
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/x;
    ...
    .line 22
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v;
    ...
    .line 24
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    ...
    .line 26
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/a0;
    ...
    .line 28
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/q;
    ...
    .line 30
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
    ...
    .line 32
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/u;
