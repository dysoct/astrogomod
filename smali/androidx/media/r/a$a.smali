...
.method constructor <init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/media/r/a$a;->c:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Landroidx/media/r/a$a;->d:Landroid/content/Intent;

    .line 4
    iput-object p3, p0, Landroidx/media/r/a$a;->e:Landroid/content/BroadcastReceiver$PendingResult;
...
.method private e()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media/r/a$a;->f:Landroid/support/v4/media/MediaBrowserCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserCompat;->b()V

    .line 2
    iget-object v0, p0, Landroidx/media/r/a$a;->e:Landroid/content/BroadcastReceiver$PendingResult;
...
.method public a()V
    ...
    iget-object v1, p0, Landroidx/media/r/a$a;->c:Landroid/content/Context;

    iget-object v2, p0, Landroidx/media/r/a$a;->f:Landroid/support/v4/media/MediaBrowserCompat;
    ...
    .line 3
    iget-object v1, p0, Landroidx/media/r/a$a;->d:Landroid/content/Intent;
    ...
    .line 6
    :goto_0
    invoke-direct {p0}, Landroidx/media/r/a$a;->e()V
...
.method f(Landroid/support/v4/media/MediaBrowserCompat;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/r/a$a;->f:Landroid/support/v4/media/MediaBrowserCompat;
